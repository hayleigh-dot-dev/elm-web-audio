...
var author$project$WebAudio$Node = F3(
	function (a, b, c) {
		return {$: 'Node', a: a, b: b, c: c};
	});
var author$project$WebAudio$audioDestination = A3(author$project$WebAudio$Node, 'AudioDestinationNode', _List_Nil, _List_Nil);
var author$project$WebAudio$dac = author$project$WebAudio$audioDestination;
var author$project$WebAudio$gain = author$project$WebAudio$Node('GainNode');
var author$project$WebAudio$oscillator = author$project$WebAudio$Node('OscillatorNode');
var author$project$WebAudio$Property$AudioParam = F2(
	function (a, b) {
...
var author$project$WebAudio$Property$frequency = A2(
	...
	author$project$WebAudio$Property$audioParam('frequency'));
var author$project$WebAudio$Property$gain = A2(
	elm$core$Basics$composeR,
	author$project$WebAudio$Property$float,
	author$project$WebAudio$Property$audioParam('gain'));
var author$project$Main$voice = function (note) {
	return A2(
		author$project$WebAudio$oscillator,
		_List_fromArray(
			[
				author$project$WebAudio$Property$frequency(
				author$project$Main$mtof(note.midi))
			]),
		_List_fromArray(
			[
				A2(
				author$project$WebAudio$gain,
				_List_fromArray(
					[
						author$project$WebAudio$Property$gain(
						note.triggered ? 0.1 : 0)
					]),
				_List_fromArray(
					[author$project$WebAudio$dac]))
			]));
};
var elm$json$Json$Encode$string = _Json_wrap;
var author$project$WebAudio$Property$encodeScheduledUpdateMethod = function (method) {
	switch (method.$) {
		case 'SetValueAtTime':
...
var author$project$WebAudio$Property$encodeScheduledUpdateValue = function (_n0) {
...
var author$project$WebAudio$Property$encode = function (property) {
	switch (property.$) {
		case 'NodeProperty':
			...
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'value',
						author$project$WebAudio$Property$encodeScheduledUpdateValue(value))
					]));
	}
};
...
var author$project$WebAudio$encode = function (n) {
	switch (n.$) {
		case 'Node':
			var t = n.a;
			var ps = n.b;
			...
			return elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						_Utils_Tuple2(
						'properties',
						A2(elm$json$Json$Encode$list, author$project$WebAudio$Property$encode, ps)),
						_Utils_Tuple2(
						'connections',
						A2(elm$json$Json$Encode$list, author$project$WebAudio$encode, cs))
					]));
		case 'Keyed':
			var k = n.a;
			var t = n.b;
